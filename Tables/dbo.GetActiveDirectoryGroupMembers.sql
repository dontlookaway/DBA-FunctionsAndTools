...
GO
ALTER TABLE [dbo].[GetActiveDirectoryGroupMembers] ADD CONSTRAINT [UQ_GetActiveDirectoryGroupMembers_GroupUserObject] UNIQUE CLUSTERED  ([GroupCanonicalName], [GroupSamAccountName], [SamAccountName], [ObjectClass]) ON [PRIMARY]
GO
